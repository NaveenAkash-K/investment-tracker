...
const navItems = [
    ...
    { href: "/operations", label: "Operations", description: "Automation health", icon: HeartPulse },
    { href: "/strategy-scorecard", label: "Scorecard", description: "Observed strategy results", icon: ClipboardCheck },
